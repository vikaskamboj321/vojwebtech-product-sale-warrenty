        ...
        <ScrollView behavior="height">
            ...
            <View style={{padding: 10}}>
                ...
                <Item style={styles.input} floatingLabel>
                    <Label>Product</Label>
                    <Input onChangeText={text => setProduct(text)} />
                </Item>
                <Item style={styles.input} floatingLabel>
                    <Label>Warrenty</Label>
                    <Input  onChangeText={text => setWarrenty(text)} />
                </Item>
                ...
                <Item style={styles.input} floatingLabel>
                    <Label>Name</Label>
                    <Input onChangeText={text => setCustomerName(text)}  />
                </Item>
                <Item style={styles.input} floatingLabel>
                    <Label>Email</Label>
                    <Input onChangeText={text => setCustomerEmail(text)}  />
                </Item>
                <Item style={styles.input} floatingLabel>
                    <Label>Mobile</Label>
                    <Input onChangeText={text => setCustomerMobile(text)}  />
                </Item>
